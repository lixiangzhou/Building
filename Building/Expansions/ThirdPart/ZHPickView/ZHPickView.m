...
-(UIView *)setToolbarStyle{
    ...
    [leftBtn setTitleColor:UIColorFromHEX(0x6E6E6E) forState:UIControlStateNormal];
    ...
    [rightBtn setTitleColor:UIColorFromHEX(0x73B8FD) forState:UIControlStateNormal];
...
- (UIView *)coverView {
    if (_coverView == nil) {
        ...
        [_coverView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(remove)]];
    }
    return _coverView;
}
